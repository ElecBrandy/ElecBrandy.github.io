...
title = '[알고리즘] 정렬'
date = 2023-11-03
featured_image = "https://i.imgflip.com/5bzny1.jpg"
tags = ['algorithm', 'cs101']
draft = true
+++
...
## 1. 정렬 알고리즘
____
정렬 알고리즘은 n개의 숫자가 입력으로 주어졌을 때, 이를 적절하게 정렬하는 알고리즘이다. 정말 다양한 정렬 알고리즘이 존재하며, 각각의 특성과 장단점이 존재한다. 기본적인 정렬 알고리즘의 개념을 알아보고, 코드로 만들어 본 후 상황에 따른 시간복잡도를 계산해보자!
